...
const UserForm = () => {
  ...
  useEffect(() => {
    // let wakeLockEnable = false;
    // const WLtoggle = document.querySelector('#toggle')
    // WLtoggle.addEventListener('click', function enableNoSleep(){
    // 	if(!wakeLockEnable){
    // 		WLtoggle.removeEventListener('click',enableNoSleep, false)
    // 		// noSleep.enable();
    // 		wakeLockEnable = true;
    // 		alert('enable no sleep')
    // 	}
    // })
  }, []);
  const formSubmit = (e) => {
